<?php
   ...
   if ( isset($_POST["submit"]))
   {
      ...
      if ( strcmp($record["password"], sha1($_POST["old_password"])) == 0)
      {
         ...
         else
         {
            ...
            header("Refresh: 3; url=index.php?content=change_userrole");
         }
      }
      else
      {
         echo "Uw oude password klopt niet. Probeer het opnieuw";
         header("Refresh: 4; url=index.php?content=change_userrole&id=".$_POST["id"]);
      }
   ...
   if ( isset($_GET["id"]))
   {
      ...
      echo "<form action='index.php?content=change_userrole' method='post'>
               <table>
                  <tr>
   ...
   // Maak van de $result resource een array (associatief) $records
   // Code...
   
   // Doorloop met een while loop de records en bouw de <tr> en <td> tags op van een tabel stop deze in een
   // variabele $innerTable
   // Code... 
   ...
   while ( $record = mysqli_fetch_array($result, MYSQLI_ASSOC))
   {
      $innerTable .= "<tr>
                        ...
                        <td><a href='index.php?content=change_userrole&id=".$record["id"]."'><img src='./images/b_edit.png' alt='potlood'></a></td>";
   }
?>
